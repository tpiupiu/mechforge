...
**Output location:** `$ARGUMENTS/.mechforge/prompts/app_spec.txt` and `$ARGUMENTS/.mechforge/prompts/initializer_prompt.md`
...
The output directory is: `$ARGUMENTS/.mechforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$ARGUMENTS/.mechforge/prompts/app_spec.txt`
...
**Output path:** `$ARGUMENTS/.mechforge/prompts/initializer_prompt.md`
...
**Output path:** `$ARGUMENTS/.mechforge/prompts/.spec_status.json`
...
```json
{
  ...
  "files_written": [
    ".mechforge/prompts/app_spec.txt",
    ".mechforge/prompts/initializer_prompt.md"
  ],
...
```json
{
  ...
  "files_written": [
    ".mechforge/prompts/app_spec.txt",
    ".mechforge/prompts/initializer_prompt.md",
    ".mechforge/prompts/coding_prompt.md"
  ],
  "feature_count": 35
}
```
...
> "Your specification files have been created in `$ARGUMENTS/.mechforge/prompts/`!
>
> **Files created:**
> - `$ARGUMENTS/.mechforge/prompts/app_spec.txt`
> - `$ARGUMENTS/.mechforge/prompts/initializer_prompt.md`
>
